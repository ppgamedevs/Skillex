...
const resend = new Resend(process.env.RESEND_API_KEY || 're_FQzMdGHx_Fp3ohnGy8ny3i9V7VAuEdbxZ');
...
// Start server
app.listen(PORT, () => {
  console.log(`🎮 Skillex Games server running on http://localhost:${PORT}`);
  console.log(`📧 Email API using Resend`);
});
